...
@section('styles')
    <style>
        /* Styles pour les détails de propriété */
        .detail-item {
        ...
        /* Animation pour le hover sur les cartes */
        .card {
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            @foreach ($property->images as $image)
                                <img src="{{ Storage::url($image->image_path) }}" class="img-fluid mb-2"
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <span class="badge bg-info">{{ $property->type_text ?? $property->type }}</span>
                                ...
                                @foreach ($property->details as $detail)
                                    <div class="col-md-6">
                                        <div class="detail-item p-3 bg-light rounded h-100">
                                            <strong class="text-muted d-block">{{ $detail->title }}</strong>
                                            <small class="d-block">{{ $detail->value }}</small>
                            ...
                            @foreach ($property->services as $service)
                                <div class="col">
                                    <div class="card h-100 border">
                                        @if ($service->image)
                                            <img src="{{ Storage::url($service->image) }}" class="card-img-top"
