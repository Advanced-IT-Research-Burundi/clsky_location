                ...
                <div class="card-body">
                    <div id="reservationSummary">
                        ...
                        <div class="mb-3">
                            ...
                            <p id="pricePerNight">-- USD</p>
                        </div>
                        <hr>
                        <div class="mb-3">
                            <label class="fw-bold">Total</label>
                            <p id="totalPrice" class="h4 text-primary">-- USD</p>
                        </div>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateSummary() {
        ...
        if (checkIn && checkOut && propertyOption) {
            ...
            document.getElementById('pricePerNight').textContent = `${pricePerNight.toFixed(2)} USD`;
