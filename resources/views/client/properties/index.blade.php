            ...
            <div class="row g-0 gx-5 align-items-end mb-4">
                <div class="col-lg-6">
                    <div class="text-start mx-auto wow slideInLeft" data-wow-delay="0.1s">
                        <h1 class="mb-3">Explorez Nos Propriétés</h1>
                        <p>Trouvez la propriété parfaite dans notre vaste collection d'annonces.</p>
                    </div>
                </div>
                        ...
                        <ul class="nav nav-pills d-flex justify-content-lg-end mb-3">
                            <li class="nav-item me-2">
                                <a class="btn btn-outline-primary {{ !request('status') ? 'active' : '' }}"
                                    href="{{ request()->url() }}">Toutes les Propriétés</a>
                            </li>
                            <li class="nav-item me-2">
                        ...
                        <form action="{{ route('client.properties.index') }}" method="GET" class="row g-3">
                            <div class="col-md-6">
                                <select name="type" class="form-select">
                                    ...
                                    <option value="house" {{ request('type') === 'house' ? 'selected' : '' }}>Maison
                                    </option>
                                    <option value="apartment" {{ request('type') === 'apartment' ? 'selected' : '' }}>
                                        Appartement</option>
                                    <option value="villa" {{ request('type') === 'villa' ? 'selected' : '' }}>Villa
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-6">
                                <select name="price_range" class="form-select">
                                    ...
                                    <option value="0-100000" {{ request('price_range') === '0-100000' ? 'selected' : '' }}>
                                        0 - 100,000 USD</option>
                                    <option value="100000-300000"
                                        {{ request('price_range') === '100000-300000' ? 'selected' : '' }}>100,000 -
                                        300,000 USD</option>
                                    <option value="300000-plus"
                                        {{ request('price_range') === '300000-plus' ? 'selected' : '' }}>300,000+ USD
                                    </option>
                                </select>
                            </div>
                            <div class="col-12">
                        ...
                        <div class="property-item rounded overflow-hidden shadow-sm">
                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        @forelse($property?->images as $key => $image)
                                            <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                                                <a class="d-block h5 mb-2 text-truncate"
                                                    href="{{ route('client.properties.show', $property->id) }}">
                                        ...
                                        @empty
                                            <div class="carousel-item active">
                                                <img src="{{ asset('img/default-property.jpg') }}" class="d-block w-100"
                            ...
                            <div class="d-flex border-top">
                                <small class="flex-fill text-center border-end py-2">
                                    <i
                                        class="fa fa-ruler-combined text-primary me-2"></i>{{ number_format($property->square_feet) }}
                                    m²
                                </small>
                                <small class="flex-fill text-center border-end py-2">
                ...
                @empty
                    <div class="col-12 text-center py-5">
                        <div class="empty-state wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <a href="{{ route('allproperties') }}" class="btn btn-primary mt-3">Effacer les Filtres</a>
                        </div>
                    </div>
                @endforelse
            </div>
