    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4 fixed-top">
        <a href="/" class="navbar-brand d-flex align-items-center text-center">
            <div class="icon p-2 me-2">
                <img class="img-fluid" src="{{ asset('img/icon-deal.png') }}" alt="Icône"
                    style="width: 30px; height: 30px;">
            </div>
            <h5 class="m-0 text-primary">CL SKY APPARTEMENT</h5>
        </a>
        ...
        <div class="collapse navbar-collapse px-1" id="navbarCollapse">
            ...
            <div class="navbar-nav ms-auto">
                ...
                <a href="{{ route('about') }}"
                    class="nav-item nav-link {{ Request::is('about') ? 'active' : '' }} small px-2">
                    À Propos
                </a>

                <a href="{{ route('contact') }}"
                    class="nav-item nav-link {{ Request::is('contact') ? 'active' : '' }} small px-2">
                    Contact
                </a>
            </div>
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                @auth
                    @if(Auth::user()->role !== 'client')
                        <a href="{{ route('dashboard') }}"
                           class="btn btn-outline-secondary btn-sm px-2 d-none d-lg-flex">
                ...
                @else
                    <a href="{{ route('client.login') }}"
                       class="btn btn-primary btn-sm px-2 d-none d-lg-flex">
                        Connexion
                    </a>
                @endauth
